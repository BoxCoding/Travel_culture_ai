...
DESTINATIONS = [
    ...
    dict(
        ...
        image_url="https://images.unsplash.com/photo-1518638150340-f706e86654de",
        lat=17.0732,
        lng=-96.7266,
    ...
    dict(
        ...
        image_url="https://images.unsplash.com/photo-1531065208531-4036c0dba3ca",
        lat=-13.5320,
        lng=-71.9675,
